  ...
  return (
    <div className="page-gradient">
      ...
      <Hero 
        ...
        description="Upload, organize, and share your photography with automatic optimization, tagging system, and client proofing capabilities. Generated by Luke Encrapera"
      />

      <SectionContainer>
        <SectionTitle title="Featured Photo" />
        <FeaturedPhoto />
      </SectionContainer>
